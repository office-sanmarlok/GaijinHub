    ...
    <section className="py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">カテゴリから探す</h2>
          <p className="text-lg text-gray-600">Browse by Categories</p>
        </div>
          ...
          {categories.map((category) => (
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-500 text-xs mb-4">{category.englishDescription}</p>
                <Button
                  variant="outline"
        ...
        <div className="mt-16 text-center">
          <div className="bg-blue-50 rounded-lg p-8">
            <h3 className="text-2xl font-bold mb-4">今すぐ投稿してみませんか？</h3>
            <p className="text-gray-600 mb-6">Ready to post your listing?</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-blue-600 hover:bg-blue-700" onClick={() => router.push('/listings/new')}>
                投稿する / Post Listing
              </Button>
